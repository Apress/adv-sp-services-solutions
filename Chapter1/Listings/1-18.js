...
function mailDocument(documentUrl)
{
    try{
        ...
        var outlookAttachment = outlookMessage.Attachments.Add(fileUrl);
        ...
        alert("This functionality requires Microsoft Outlook to be installed and the associated Windows SharePoint Services site to be trusted.");
    }
}
